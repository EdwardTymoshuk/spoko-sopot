        ...
        <div className="my-12 flex flex-col md:flex-row-reverse items-center gap-8">
          <div className="md:w-1/2">
            ...
            <p className="text-lg text-text-foreground">
              &quot;W naszej kuchni każdy składnik jest traktowany z najwyższym
              szacunkiem. Stawiamy na lokalne produkty oraz innowacyjne
              podejście, aby tworzyć dania, które nie tylko smakują, ale także
              zachwycają wizualnie. Nasza oferta to połączenie tradycyjnych
              polskich smaków z nowoczesnymi trendami kulinarnymi. Serdecznie
              zapraszamy do odkrywania naszych specjałów!&quot;
            </p>
            <p className="mt-4 font-semibold">
              — Lesia Voloshyna, Szef Kuchni Restauracji Spoko
            </p>
          </div>
        ...
        <div className="my-12">
          <div className="flex flex-col md:flex-row items-center gap-8">
            <div className="md:w-1/2">
              ...
              <p className="text-lg text-text-foreground">
                Nasz zespół to doświadczeni pasjonaci kulinariów, którzy dbają o
                każdy szczegół – od przyjaznego powitania po perfekcyjnie
                przygotowane dania. Dzięki naszej pracy tworzymy miejsce, gdzie
                każdy gość czuje się wyjątkowo. Oferujemy ciepłą, przyjazną
                atmosferę, która sprawia, że każda wizyta w Restauracji Spoko
                staje się niezapomnianym przeżyciem. Przyjdź i doświadcz
                kulinarnej magii, jaką tworzymy specjalnie dla Ciebie!
              </p>
            </div>
            <div className="md:w-1/2 md:h-auto">
              <Image
