        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 py-8 h-full">
          <div className="space-y-6 justify-self-center content-center">
            <div>
              ...
              <p className="text-lg">
                Telefon:{' '}
                <a href="tel:+48530659666" className="text-primary">
                  +48 530 659 666
                </a>
              </p>
              <p className="text-lg">
                Email:{' '}
                <a href="mailto:info@spokosopot.pl" className="text-primary">
                  info@spokosopot.pl
                </a>
              </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-12">
          ...
          <div className="space-y-6 justify-self-center content-center w-full">
            <h2 className="text-2xl font-bold text-secondary text-center">
              Wypełnij formularz, aby skontaktować się z nami. Chętnie odpowiemy
              na Twoje pytania lub przyjmiemy rezerwację.
            </h2>
            <Form {...form}>
              <form
